  ...
  return (
    <article className={narrowClass}>
      ...
      <p className={ledeClass}>
        A Willow Book is a live guestbook for personal events. Guests scan a QR
        code — no account, no app, no email.
      </p>

      <dl className='mt-10 space-y-8'>
        {FAQS.map((item) => (
          <div key={item.q}>
            <dt className='mb-2 font-serif text-[1.15rem] font-medium text-ink'>
              {item.q}
            </dt>
