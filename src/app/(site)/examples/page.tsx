  ...
  return (
    <article className='mx-auto max-w-[900px]'>
      ...
      <p className={`${ledeClass} max-w-[40rem]`}>
        Each occasion has a short landing page and a live demo guestbook you can
        open without creating anything. No accounts. No checkout.
      </p>
          ...
          <div className='w-full min-[700px]:max-w-[calc((100%-1rem)/2)] rounded-xl border border-[color-mix(in_srgb,var(--color-ink)_12%,transparent)] bg-cream/70 px-5 py-5'>
            <div className='flex items-start gap-4'>
              ...
              <div className='min-w-0 flex-1'>
                ...
                <Link
                  className={marketingLinkClass}
                  href={HOME_OCCASION_YOU_PICK.path}
                >
