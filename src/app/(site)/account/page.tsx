  ...
  return (
    <section className={narrowClass}>
      ...
      <p className={ledeClass}>
        Guestbooks you create while signed in live here. Your host link still
        works as a spare key.
      </p>
            ...
            return (
              ...
              >
                <h2 className='text-[1.15rem]'>
                  {event.coupleNames || copy.displayNameFallback}
                </h2>
                ...
                <div className={`${btnRowClass} mt-4`}>
                  <a
                    ...
                    href={eventGuestbookPath(event.slug)}
                  >
                    Open guestbook
                  </a>
                  <a
                    className={btnClass('ghost')}
                    href={eventManagePath(event.slug)}
                  >
                    Host tools
                  </a>
                </div>
