...
export type EventCopyPack = {
  ...
  wallLoadingLabel: string;
  wallCtaLabel: string;
  wallEmptyLabel: string;
...
const WEDDING_COPY: EventCopyPack = {
  ...
  displayNameHint: "Shown on the guest page and the wall.",
  ...
  defaultWelcomeMessage: "Leave a toast — a memory, a wish, or a photo. No account needed.",
  ...
  wallLoadingLabel: "Gathering toasts…",
  wallCtaLabel: "Leave a toast",
  wallEmptyLabel: "The first toast hasn’t been written yet. Scan the QR and be the first.",
  ...
  hideConfirmLabel: "Remove this toast from the wall?",
  ...
  signScanInstruction: "Scan to leave a toast and upload a photo.",
  signTagline: "No app. No login. It appears on the wall.",
  keepsafeLede:
...
const BIRTHDAY_COPY: EventCopyPack = {
  ...
  defaultWelcomeMessage: "Leave a wish — a memory, a joke, or a photo. No account needed.",
  ...
  wallLoadingLabel: "Gathering wishes…",
  wallCtaLabel: "Leave a wish",
  wallEmptyLabel: "The first wish hasn’t been written yet. Scan the QR and be the first.",
  ...
  hideConfirmLabel: "Remove this wish from the wall?",
  ...
  signScanInstruction: "Scan to leave a wish and upload a photo.",
  signTagline: "No app. No login. It appears on the wall.",
  keepsafeLede:
...
const GRADUATION_COPY: EventCopyPack = {
  ...
  defaultWelcomeMessage: "Leave a wish — advice, a memory, or a photo. No account needed.",
...
const RELIGIOUS_MILESTONE_COPY: EventCopyPack = {
  ...
  defaultWelcomeMessage:
    "Leave a note — a blessing, a memory, or a photo. No account needed.",
  ...
  wallLoadingLabel: "Gathering notes…",
  wallCtaLabel: "Leave a note",
  wallEmptyLabel: "The first note hasn’t been written yet. Scan the QR and be the first.",
  ...
  hideConfirmLabel: "Remove this note from the wall?",
  ...
  signScanInstruction: "Scan to leave a note and upload a photo.",
  signTagline: "No app. No login. It appears on the wall.",
  keepsafeLede:
    "{name}’s guestbook is live. Print the table sign for your celebration. Keep the host link somewhere only you can find.",
  keepsafeBackupFolderHint:
...
const OTHER_COPY: EventCopyPack = {
  ...
  defaultWelcomeMessage: "Leave a note — a memory, a greeting, or a photo. No account needed.",
