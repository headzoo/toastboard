...
const WEDDING_COPY: EventCopyPack = {
  ...
  createWelcomePlaceholder:
    'Leave us a toast — a memory, a wish, a terrible joke.',
  defaultWelcomeMessage:
    'Leave a toast — a memory, a wish, photos, or one short video. No account needed.',
  ...
  guestbookEmptyLabel:
    'The first toast hasn’t been written yet. Scan the QR and be the first.',
  moderationIntro:
    'Hide a toast if you need to. Guests never see these buttons.',
  moderationEmptyLabel:
    'No toasts yet. Share the guest QR and they’ll land here.',
  ...
  signScanInstruction:
    'Scan to leave a toast and upload photos or one short video.',
...
const BIRTHDAY_COPY: EventCopyPack = {
  ...
  createWelcomePlaceholder:
    'Leave a wish — a memory, a joke, or a photo from the party.',
  defaultWelcomeMessage:
    'Leave a wish — a memory, a joke, photos, or one short video. No account needed.',
  guestKickerFallback: 'A birthday guestbook',
  messageNoun: 'wish',
  messageNounPlural: 'wishes',
  messageFieldLabel: 'Your wish',
  messageFieldPlaceholder:
    'Wishing you another year of joy, laughter, and terrible puns.',
  submitButtonLabel: 'Add to the guestbook',
  submitBusyLabel: 'Sending…',
  ...
  guestbookEmptyLabel:
    'The first wish hasn’t been written yet. Scan the QR and be the first.',
  moderationIntro:
    'Hide a wish if you need to. Guests never see these buttons.',
  moderationEmptyLabel:
    'No wishes yet. Share the guest QR and they’ll land here.',
  ...
  signScanInstruction:
    'Scan to leave a wish and upload photos or one short video.',
  signTagline: 'No app. No login. It appears in the guestbook.',
  keepsafeLede:
...
const GRADUATION_COPY: EventCopyPack = {
  ...
  createWelcomePlaceholder:
    'Leave a wish — advice, a memory, or congratulations for the grad.',
  defaultWelcomeMessage:
    'Leave a wish — advice, a memory, photos, or one short video. No account needed.',
  guestKickerFallback: 'A graduation guestbook',
  messageNoun: 'wish',
  messageNounPlural: 'wishes',
  messageFieldLabel: 'Your wish',
  messageFieldPlaceholder:
    'The world is wide open — go make something wonderful.',
  submitButtonLabel: 'Add to the guestbook',
  submitBusyLabel: 'Sending…',
  submitErrorFallback: 'Couldn’t send that wish.',
  thankYouHeadline: 'Thank you! Your wish has been added 💌',
...
const RELIGIOUS_MILESTONE_COPY: EventCopyPack = {
  ...
  messageFieldPlaceholder:
    'Mazel tov — may this milestone be the start of many good things.',
  submitButtonLabel: 'Add to the guestbook',
  submitBusyLabel: 'Sending…',
  ...
  guestbookEmptyLabel:
    'The first note hasn’t been written yet. Scan the QR and be the first.',
  moderationIntro:
    'Hide a note if you need to. Guests never see these buttons.',
  moderationEmptyLabel:
    'No notes yet. Share the guest QR and they’ll land here.',
  ...
  signScanInstruction:
    'Scan to leave a note and upload photos or one short video.',
  signTagline: 'No app. No login. It appears in the guestbook.',
  keepsafeLede:
    '{name}’s guestbook is live. Print the table sign for your celebration. Keep the host link somewhere only you can find.',
  keepsafeBackupFolderHint:
...
const OTHER_COPY: EventCopyPack = {
  ...
  createWelcomePlaceholder:
    'Leave a note — a memory, a greeting, or a photo from the day.',
  defaultWelcomeMessage:
    'Leave a note — a memory, a greeting, photos, or one short video. No account needed.',
...
export function formatKeepsafeLede(
  copy: EventCopyPack,
  displayName: string,
): string {
