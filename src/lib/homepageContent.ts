...
export const HOME_FEATURES: HomeFeature[] = [
  {
    ...
    description:
      "Guests never create an account. They scan, write, add pictures and video and they're done.",
  ...
  },
  {
    ...
    description:
      'Collect notes, photos, and one short video on a live guestbook. Watch for just about anywhere.',
  ...
  },
  {
    title: 'Yours to keep',
    description:
      'Create your guestbook once. Keep every word by revisiting your guestbook over and over.',
  ...
  },
  {
    ...
    description:
      "If you're not satisfied for any reason, we'll return your money. No questions asked.",
...
export const HOME_OCCASIONS: HomeOccasion[] = [
  {
    title: 'Weddings',
    description:
      'Collect messages from your ceremony, reception, or bridal shower.',
  ...
  },
  {
    title: 'Birthdays',
    description:
      'Gather birthday wishes, photos, and videos in one beautiful place.',
  ...
  },
  {
    title: 'Graduations',
    description:
      'Celebrate the milestone with advice, memories, and words of encouragement.',
  ...
  },
  {
    ...
    description:
      'Bar mitzvah, bat mitzvah, confirmation, and similar celebrations.',
...
export const HOME_OCCASION_YOU_PICK: HomeOccasion = {
  title: 'You pick',
  description:
    'Reunion, farewell, baby shower, or anything else — name it yourself.',
  ...
  items: [
    {
      ...
      span: 'full',
      quote:
        'Still can’t believe you two met over the last samosa. Please never stop telling that story.',
      attribution: 'Priya',
      photo: {
        src: '/images/guestbook-priya-1.jpg',
        alt: 'A wedding guest smiling at an evening reception',
    ...
    },
    {
      ...
      span: 'half',
      quote:
        'The guestbook is already prettier than our Slack channel. Congratulations, you two.',
    ...
    },
    {
      ...
      span: 'half',
      quote:
        'Left a toast without making an account, which feels like the most 2026 thing we could have done for you.',
    ...
    },
    {
      ...
      span: 'half',
      quote:
        'I was asked to be profound. Instead: don’t forget to eat cake. Also I love you both.',
