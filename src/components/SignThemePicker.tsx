        ...
        {SIGN_THEMES.map((theme) => {
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2.5 rounded-[1rem] border-0 bg-cream px-3 py-2.5 text-left${
                isSelected
                  ? ' outline outline-3 outline-offset-2 outline-ink'
                  : ''
              }${
                isPending && !isSelected
                  ? ' outline outline-2 outline-offset-2 outline-ink-soft'
                  : ''
            ...
            >
              ...
              <span className='min-w-0'>
                <span className='block text-[0.88rem] font-bold leading-tight'>
                  {theme.label}
                </span>
