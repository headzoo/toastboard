...
export function SlideshowSettingsDialog({
  ...
  const selectDuration = (duration: SlideshowDuration) =>
    onChange({ ...preferences, duration });
  const selectMotion = (motion: MotionStyle) =>
    onChange({ ...preferences, motion });
  const selectSignTheme = (signTheme: SignThemeId) =>
    onChange({ ...preferences, signTheme });

  return (
    <div
      className='slideshow-dialog-backdrop'
      role='presentation'
      onMouseDown={onClose}
    >
      <div
      ...
      >
        <div className='slideshow-dialog-heading'>
          ...
          <button
            className='slideshow-icon-button'
            type='button'
            onClick={onClose}
